...
<div style={{textAlign: 'center', margin: '24px 0'}}>
  ...
  <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', gap: '20px'}}>
    ...
    <img src="/img/compliance/terraform.png" alt="Terraform" height="70" style={{objectFit: 'contain', borderRadius: '6px', padding: '8px', background: 'var(--ifm-color-emphasis-200)'}} />
    <img src="/img/compliance/bitwarden.png" alt="Bitwarden" height="70" style={{objectFit: 'contain'}} />
